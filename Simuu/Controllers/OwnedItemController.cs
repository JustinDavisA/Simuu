...
namespace Simuu.Controllers
{
    public class OwnedItemController : Controller
    {
        ...
        {
            if (User.IsInRole(Constraints.AdminRoleName))
            {
                return true;
            }
            UserBLL me = ctx.User_FindByUserEmail(User.Identity.Name);
            if (me == null)
            {
                return false;
            }
        ...
        public ActionResult Page(int PageNumber, int PageSize)
        {
            ...
            try
            {
                ...
                {
                    UserBLL currentUser = ctx.User_FindByUserEmail(User.Identity.Name);
                    if (null == currentUser)
                    {
